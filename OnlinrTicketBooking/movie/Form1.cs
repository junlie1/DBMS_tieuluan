...
namespace movie
{
    public partial class Form1 : Form
    {
        ...
        private string connectionString = "Server=LAIVUNG\\SQLEXPRESS;Database=CinemaDB;Trusted_Connection=True;";
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    SqlCommand cmdCustomer = new SqlCommand("IF NOT EXISTS (SELECT * FROM Customer WHERE FullName = @Name) INSERT INTO Customer (FullName) VALUES (@Name); SELECT CustomerID FROM Customer WHERE FullName = @Name;", conn);
